...
// teacherJson = teachers.map((teacher) => {
//     return {
//         nuptk: teacher[0],
//         name: teacher[1],
//         nip: teacher[2],
...
studentJson = students.map((student) => {
    return {
        nisn: student[0],
        name: student[1],
        gender: student[2],
        place_of_birth: student[3],
        date_of_birth: student[4],
        religion: student[5],
        address: student[6],
        rombongan_belajar: student[7],
    };
});
