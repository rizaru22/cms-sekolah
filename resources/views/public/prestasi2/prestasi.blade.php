...
<div class="container-fluid prestasi p-0">
    <div class="row">
        <div class="col-md-3 col-sm-6 col-12 col_prestasi_1">
            <a href="{{ route('prestasi_tampilan.penelitian') }}">
            <div class="content">
        ...
        <a href="{{ route('prestasi_tampilan.olahraga') }}">
            <div class="content">
                <div class="text-center">
        ...
        <a href="{{ route('prestasi_tampilan.sains') }}">
            <div class="content">
                <div class="text-center">
        ...
        <a href="{{ route('prestasi_tampilan.seni') }}">
            <div class="content">
                <div class="text-center">
