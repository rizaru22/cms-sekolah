...
<div class="container-xl">
    ...
    <div class="page-header d-print-none">
        ...
        <form action="{{ route('dashboard.PrestasiolahragaISI.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="nama_lomba" class="form-control" name="nama_lomba" autocomplete="olahraga-nama_lomba" value="">
                                        @error('nama_lomba')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tingkat" class="form-control" name="tingkat" autocomplete="olahraga-tingkat" value="">
                                        @error('tingkat')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    ...
                    <!-- Input text untuk menampilkan datepicker -->
