...
<div class="container-xl">
    ...
    <div class="page-header d-print-none">
        ...
        <form action="{{ route('dashboard.PrestasiseniISI.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="nama_lomba" class="form-control" name="nama_lomba" autocomplete="seni-nama_lomba" value="">
                                        @error('nama_lomba')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tingkat" class="form-control" name="tingkat" autocomplete="seni-tingkat" value="">
                                        @error('tingkat')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="datepicker"  class="form-control" name="tanggal_pelaksanaan" autocomplete="seni-tanggal_pelaksanaan" value="">
