...
<div class="container-fluid">
  <div class="row">
      <div class="me-auto">
        <a href="{{ route('dashboard.prestasi_isi.sainsindex') }}">
      ...
      <div class="col-md-3">
        <div class="profile-card-4 text-center bg-white">
          ...
          <div class="d-flex justify-content-center">
            <a class="btn btn-sm btn-info" title="Edit data" href="{{ route('dashboard.PrestasisainsISI.edit', $psai->id)  }}">

              <i class="fas fa-edit"></i> Edit
            </a>
            <form id="deleteForm" action="{{ route('dashboard.PrestasisainsISI.destroy' ,$psai->id) }}" method="post">
              @csrf
              @method('DELETE')
